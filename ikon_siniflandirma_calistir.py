...
MODEL = "gemini-2.5-flash-lite"  # 2.0-flash-lite kaldirildi, 3.5-flash-lite "prepayment credits" hatasi verdi -- 2.5-flash-lite birden fazla kaynakta ucretsiz olarak dogrulandi
