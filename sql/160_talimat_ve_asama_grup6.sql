-- 160_talimat_ve_asama_grup6.sql
-- 515 yeni tarifin talimat+asama yazimi -- Grup 6: Parti5(tarif-
-- ekleme)'nin 56 tarifi, 7 bolgeye esit.
-- Ayni _talimat_ve_asama_ekle_v2 fonksiyonu (155-159 ile ayni).
-- Su eklemeleri orijinal Parti5 malzeme listeleriyle CAPRAZ
...
begin
    perform _talimat_ve_asama_ekle_v2(
        'İstanbul Usulü Midye Salatası', null, '**Hazırlık / Mise en Place**
1. Midyeleri temizleyip süzün. Marulu ayıklayıp yıkayın, elinizle parçalayın.

**Isıl İşlem**
1. Haşlama (~95°C, tencerede, 10 dk): Tencereye 300 ml (300 g) su koyup kaynatın. Midyeleri ekleyip kabukları açılıp pişene kadar (~5 dk) haşlayın, süzün.
2. Son işlemler: Haşlanmış midyeleri ılıyınca marul, zeytinyağı, limon suyu ve tuzla karıştırıp servis edin.

**PARALEL YAPILABİLİRLİK:** Midye haşlanırken marul hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme ~5 dk · Toplam ~20 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Haşlama", "sure_dakika": 10, "aktif_dakika": 5, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 95, "enerji_kaynagi": "dogalgaz", "malzemeler": ["MİDYE", "SU"], "yeni_su_gram": 300}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Bursa Usulü Zeytinyağlı Kereviz', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kırklareli Usulü Kavurmalı Yumurta', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme yok · Toplam ~15 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Tekirdağ Usulü Fırın Sütlaç', null, '**Hazırlık / Mise en Place**
1. Fırını 180°C''ye ısıtmaya başlayın.
2. Pirinci yıkayıp süzün.

**Isıl İşlem**
1. Fırınlama (180°C, 30 dk): Sütü, pirinci ve şekeri bir tencerede kaynatıp pirinç yumuşayana kadar (~15 dk) pişirin. Mısır nişastasını birkaç kaşık soğuk sütle karıştırıp ekleyin, koyulaşana kadar karıştırın. Fırın kaplarına paylaştırıp 180°C fırında üzeri benekli kızarana kadar (~15 dk) pişirin.

**PARALEL YAPILABİLİRLİK:** Fırın ısınırken süt karışımı hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme ~25 dk · Toplam ~40 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Fırınlama", "sure_dakika": 30, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 95, "enerji_kaynagi": "elektrik", "malzemeler": ["SÜT (TAM YAĞ)", "PİRİNÇ (HAM)", "ŞEKER", "MISIR NİŞASTASI"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Çanakkale Usulü Zeytinyağlı Taze Fasulye', null, '**Hazırlık / Mise en Place**
1. Taze fasulyenin iplerini ayıklayıp uzunlamasına ikiye bölün. Domatesin kabuğunu soyup küçük küp doğrayın, kuru soğanı ince yarım ay dilimleyin.

**Isıl İşlem**
1. Pişirme (~95°C, tencerede, 22 dk): Zeytinyağında soğanı 3-4 dk kavurun, şekeri ekleyip 1 dk çevirin. Domatesi ekleyip 3-4 dk pişirin. Taze fasulyeyi ve tuzu ekleyip kapağı kapalı olarak kısık ateşte fasulye yumuşayana kadar pişirin.

**PARALEL YAPILABİLİRLİK:** Pişirme kapaklı ve kısık ateşte ilerlediği için bu sürede başka tarifler hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 95, "enerji_kaynagi": "dogalgaz", "malzemeler": ["TAZE FASULYE", "DOMATES", "KURU SOĞAN", "ZEYTİNYAĞI", "ŞEKER", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Balıkesir Usulü Zeytinyağlı Enginarlı Bezelye', null, '**Hazırlık / Mise en Place**
1. Enginarları dilimleyin, kararmaması için limonlu suda bekletin. Kuru soğanı ince yarım ay dilimleyin.

**Isıl İşlem**
1. Pişirme (~90°C, tencerede, 22 dk): Zeytinyağında soğanı 3-4 dk kavurun, şekeri ekleyip 1 dk çevirin. Enginarı ekleyip 3 dk çevirin. Bezelyeyi ve tuzu ekleyip kapağı kapalı olarak kısık ateşte sebzeler yumuşayana kadar pişirin.

**PARALEL YAPILABİLİRLİK:** Pişirme kapaklı ve kısık ateşte ilerlediği için bu sürede başka tarifler hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["BEZELYE", "ENGİNAR", "KURU SOĞAN", "ZEYTİNYAĞI", "ŞEKER", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Marmara Usulü İncirli Kaşar Tabağı', null, '**Hazırlık / Mise en Place**
1. Kuru incirleri ikiye bölün, kaşarı dilimleyin, cevizleri kabaca kırın.
2. Hepsini servis tabağında düzenleyerek servis edin.

**Isıl İşlem**
Isıl işlem yok.

**PARALEL YAPILABİLİRLİK:** İncir hazırlanırken kaşar dilimlenebilir.
...
**SÜRE ÖZETİ:** Aktif işçilik ~10 dk · Pasif bekleme yok · Toplam ~10 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'İstanbul Usulü Limonlu Tavuk Sote', null, '**Hazırlık / Mise en Place**
1. Tavuk göğsünü kuşbaşı doğrayın, sarımsağı ince kıyın.

**Isıl İşlem**
1. Sote (~90°C, tavada, 20 dk): Zeytinyağında tavuğu her tarafı renk alana kadar 8-10 dk çevirin. Sarımsağı ekleyip 1 dk çevirin. Limon suyu, tuz ve karabiberi ekleyip tavuk pişene kadar (~8-10 dk) pişirin.

**PARALEL YAPILABİLİRLİK:** Tavuk pişerken sarımsak hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~25 dk · Pasif bekleme ~5 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Sote", "sure_dakika": 20, "aktif_dakika": 15, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["TAVUK GÖĞÜS", "LİMON SUYU", "SARIMSAK", "ZEYTİNYAĞI", "TUZ", "KARABİBER"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'İzmir Usulü Zeytinyağlı Nohutlu Enginar', null, '**Hazırlık / Mise en Place**
1. Enginarları dilimleyin, kararmaması için limonlu suda bekletin. Kuru soğanı ince yarım ay dilimleyin.

**Isıl İşlem**
1. Pişirme (~90°C, tencerede, 22 dk): Zeytinyağında soğanı 3-4 dk kavurun. Enginar ve nohudu, tuzu ekleyip kapağı kapalı olarak kısık ateşte enginar yumuşayana kadar pişirin.

**PARALEL YAPILABİLİRLİK:** Pişirme kapaklı ve kısık ateşte ilerlediği için bu sürede başka tarifler hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["ENGİNAR", "NOHUT", "KURU SOĞAN", "ZEYTİNYAĞI", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Muğla Usulü Bal Kaymaklı Kahvaltı Tabağı', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~10 dk · Pasif bekleme yok · Toplam ~10 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Datça Usulü Bademli Zeytinyağlı Salata', null, '**Hazırlık / Mise en Place**
1. Marulu ayıklayıp yıkayın, elinizle parçalayın.
2. Bademleri kabaca kırın. Marul ve bademi karıştırın, zeytinyağı ve limon suyuyla tatlandırıp servis edin.

**Isıl İşlem**
Isıl işlem yok.

**PARALEL YAPILABİLİRLİK:** Marul yıkanırken badem kırılabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~10 dk · Pasif bekleme yok · Toplam ~10 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Fethiye Usulü Izgara Karides', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme ~5 dk · Toplam ~20 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Salihli Usulü Üzümlü Pilav', null, '**Hazırlık / Mise en Place**
1. Pirinci yıkayıp süzün.

**Isıl İşlem**
1. Pişirme (~100°C, tencerede, 20 dk): Tereyağında pirinci 2 dk çevirin. Kuru üzümü, sıcak tavuk suyu ve tuzu ekleyin; kaynayınca ateşi kısıp kapağı kapalı olarak pirinç suyunu çekene kadar pişirin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~13 dk · Pasif bekleme ~12 dk · Toplam ~25 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 5, "aktif_dakika": 5, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 20, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 100, "enerji_kaynagi": "dogalgaz", "malzemeler": ["PİRİNÇ (HAM)", "KURU ÜZÜM", "TEREYAĞI", "TAVUK SUYU", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Nazilli Usulü Etli Nohutlu Bamya', null, '**Hazırlık / Mise en Place**
1. Kuzu etini 2 cm kuşbaşı doğrayın. Bamyaların saplarını temizleyin, kuru soğanı küçük küp doğrayın.

**Isıl İşlem**
1. Pişirme (~95°C, tencerede, 30 dk): Eti kendi yağında suyunu salıp çekene ve renk alana kadar kavurun. Soğanı ekleyip 3-4 dk kavurun. Bamya ve nohudu, 200 ml (200 g) sıcak su, tuz ve karabiberi ekleyin; kaynayınca ateşi kısıp kapağı kapalı olarak et ve bamyalar yumuşayana kadar pişirin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme ~10 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'İzmir Usulü Üzümlü Komposto', null, '**Hazırlık / Mise en Place**
1. Üzümleri yıkayıp tanelerini ayırın.

**Isıl İşlem**
1. Pişirme (~95°C, tencerede, 17 dk): 70 ml (70 g) su ve şekeri kaynatın. Üzümleri ekleyip kısık ateşte 8-10 dk pişirin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Mersin Usulü Etli Bamya', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~25 dk · Pasif bekleme ~20 dk · Toplam ~45 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Adana Usulü Nohutlu Kavurma', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Hatay Usulü Zeytinyağlı Enginar', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Silifke Usulü Zeytinyağlı Taze Bakla', null, '**Hazırlık / Mise en Place**
1. Baklaları ayıklayıp yıkayın, kuru soğanı ince yarım ay dilimleyin, taze dereotu ince kıyın.

**Isıl İşlem**
1. Pişirme (~90°C, tencerede, 22 dk): Zeytinyağında soğanı 3-4 dk kavurun. Baklaları ve tuzu ekleyip kapağı kapalı olarak kısık ateşte bakla yumuşayana kadar pişirin.
2. Son işlemler: Ocaktan alıp üzerine taze dereotu serperek soğuk servis edin (soğuma süresi özete dahil değildir).

**PARALEL YAPILABİLİRLİK:** Pişirme kapaklı ve kısık ateşte ilerlediği için bu sürede başka tarifler hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["BAKLA", "KURU SOĞAN", "ZEYTİNYAĞI", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Antalya Usulü Portakallı Muhallebi', null, '**Hazırlık / Mise en Place**
1. Portakalın kabuğunu ince rendeleyin.
2. Mısır nişastasını birkaç kaşık soğuk sütle pürüzsüz bir bulamaç haline getirin.

**Isıl İşlem**
1. Pişirme (~90°C, tencerede, 22 dk): Kalan sütü, portakal kabuğu rendesini ve şekeri bir tencerede ısıtın. Kaynamaya yakın gelince nişasta bulamacını azar azar ekleyip sürekli karıştırarak kıvam alana kadar (~12 dk) pişirin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Osmaniye Usulü Zeytinyağlı Taze Fasulye', null, '**Hazırlık / Mise en Place**
1. Taze fasulyenin iplerini ayıklayıp uzunlamasına ikiye bölün. Domatesin kabuğunu soyup küçük küp doğrayın, kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Ankara Usulü Etli Nohutlu Bulgur Pilavı', null, '**Hazırlık / Mise en Place**
1. Bulguru yıkayıp süzün, nohut haşlanmışsa süzün, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 25, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 100, "enerji_kaynagi": "dogalgaz", "malzemeler": ["DANA KIYMA", "BULGUR", "NOHUT", "KURU SOĞAN", "TUZ", "KARABİBER", "SU"], "yeni_su_gram": 100}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Konya Usulü Zeytinyağlı Pırasa', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kayseri Usulü Kavurmalı Yumurta', null, '**Hazırlık / Mise en Place**
1. Yumurtaları çırpın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme yok · Toplam ~15 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Sivas Usulü Zeytinyağlı Nohutlu Kabak', null, '**Hazırlık / Mise en Place**
1. Kabağı kalın küp doğrayın, kuru soğanı ince yarım ay dilimleyin.

**Isıl İşlem**
1. Pişirme (~90°C, tencerede, 22 dk): Zeytinyağında soğanı 3-4 dk kavurun, şekeri ekleyip 1 dk çevirin. Kabak ve nohudu, tuzu ekleyip kapağı kapalı olarak kısık ateşte kabak yumuşayana kadar pişirin.

**PARALEL YAPILABİLİRLİK:** Pişirme kapaklı ve kısık ateşte ilerlediği için bu sürede başka tarifler hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["KABAK", "NOHUT", "KURU SOĞAN", "ZEYTİNYAĞI", "ŞEKER", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Niğde Usulü Elmalı Cevizli Tatlı', null, '**Hazırlık / Mise en Place**
1. Elmaları soyup dilimleyin.

**Isıl İşlem**
1. Pişirme (~95°C, tencerede, 20 dk): Elma dilimlerini ve şekeri bir tencerede kısık ateşte kendi suyunu bırakıp yumuşayana kadar pişirin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~12 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Aksaray Usulü Etli Kabak Yemeği', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~15 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kırşehir Usulü Zeytinyağlı Enginar', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Çorum Usulü Nohutlu Tavuk Sote', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~12 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Trabzon Usulü Zeytinyağlı Kuru Fasulye', null, '**Hazırlık / Mise en Place**
...
**Isıl İşlem**
1. Pişirme (~100°C, tencerede, 30 dk): Zeytinyağında soğanı 3-4 dk kavurun. Domatesi ekleyip 3 dk pişirin. Islatılmış fasulyeyi ekleyin, 300 ml (300 g) sıcak su ve tuzu ekleyin; kaynayınca ateşi kısıp kapağı kapalı olarak fasulye tamamen yumuşayana kadar pişirin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~22 dk · Toplam ~40 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Rize Usulü Mısır Ekmekli Kaymak Tabağı', null, '**Hazırlık / Mise en Place**
1. Hazır mısır ekmeğini dilimleyin.
2. Kaymağı tabağa yayıp üzerine balı gezdirin, mısır ekmeğiyle birlikte servis edin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~10 dk · Pasif bekleme yok · Toplam ~10 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Samsun Usulü Etli Lahana Yemeği', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~20 dk · Toplam ~40 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Giresun Usulü Fındıklı Muhallebi', null, '**Hazırlık / Mise en Place**
1. Fındıkları kabaca kırın.
2. Mısır nişastasını birkaç kaşık soğuk sütle pürüzsüz bir bulamaç haline getirin.

**Isıl İşlem**
1. Pişirme (~90°C, tencerede, 22 dk): Kalan sütü, fındıkları ve şekeri bir tencerede ısıtın. Kaynamaya yakın gelince nişasta bulamacını azar azar ekleyip sürekli karıştırarak kıvam alana kadar (~12 dk) pişirin.
2. Son işlemler: Servis kaselerine paylaştırıp soğutun (soğuma süresi özete dahil değildir).

**PARALEL YAPILABİLİRLİK:** Fındık kırılırken süt ısıtılabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~12 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 10, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["SÜT (TAM YAĞ)", "FINDIK (İÇ)", "ŞEKER", "MISIR NİŞASTASI"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Ordu Usulü Zeytinyağlı Taze Fasulye', null, '**Hazırlık / Mise en Place**
1. Taze fasulyenin iplerini ayıklayıp uzunlamasına ikiye bölün. Domatesin kabuğunu soyup küçük küp doğrayın, kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Artvin Usulü Kaşarlı Mısır Ekmeği', null, '**Hazırlık / Mise en Place**
1. Fırını 200°C''ye ısıtmaya başlayın, kalıbı yağlayın.
2. Kaşarı rendeleyin. Mısır unu, ekmeklik un, kaşar, yumurta ve tuzu karıştırıp pürüzsüz bir hamur elde edin.

**Isıl İşlem**
1. Fırınlama (200°C, 20 dk): Hamuru kalıba dökün. 200°C''ye önceden ısıtılmış fırında üzeri altın rengi olup ortasına batırılan kürdan temiz çıkana kadar pişirin.

**PARALEL YAPILABİLİRLİK:** Fırın ısınırken hamur hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~15 dk · Toplam ~35 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 15, "aktif_dakika": 15, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Fırınlama", "sure_dakika": 20, "aktif_dakika": 5, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 95, "enerji_kaynagi": "elektrik", "malzemeler": ["MISIR UNU", "EKMEKLİK UN", "KAŞAR PEYNİRİ", "TAVUK YUMURTASI", "TUZ", "SU"], "yeni_su_gram": 50}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Bayburt Usulü Etli Kavurma', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Tokat Usulü Zeytinyağlı Nohutlu Pırasa', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Erzurum Usulü Etli Nohutlu Kavurma', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~15 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Van Usulü Balı ile Ceviz Tabağı', null, '**Hazırlık / Mise en Place**
1. Cevizleri kabaca kırıp servis tabağına dizin.
2. Üzerine balı gezdirerek servis edin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~10 dk · Pasif bekleme yok · Toplam ~10 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kars Usulü Etli Kavurma', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Ağrı Usulü Zeytinyağlı Nohut', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Muş Usulü Etli Pazı Yemeği', null, '**Hazırlık / Mise en Place**
1. Kuzu etini 2 cm kuşbaşı doğrayın. Pazıyı yıkayıp iri kıyın, kuru soğanı küçük küp doğrayın.

**Isıl İşlem**
1. Kavurma ve Pişirme (~90°C, tencerede, 25 dk): Eti kendi yağında suyunu salıp çekene ve renk alana kadar 15 dk kavurun. Soğanı ekleyip 3-4 dk kavurun. Pazıyı, tuz ve karabiberi ekleyip pörsüyüp yumuşayana kadar pişirin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~35 dk · Pasif bekleme yok · Toplam ~35 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Kavurma ve Pişirme", "sure_dakika": 25, "aktif_dakika": 20, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["KUZU ETİ (KOL)", "PAZI", "KURU SOĞAN", "TUZ", "KARABİBER"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Malatya Usulü Kayısılı Komposto', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~14 dk · Pasif bekleme ~11 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Elazığ Usulü Etli Nohutlu Bulgur', null, '**Hazırlık / Mise en Place**
1. Bulguru yıkayıp süzün, nohut haşlanmışsa süzün, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Bitlis Usulü Zeytinyağlı Semizotu', null, '**Hazırlık / Mise en Place**
1. Semizotunu ayıklayıp yıkayın, iri kıyın. Kuru soğanı ince yarım ay dilimleyin, pirinci yıkayıp süzün.
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme ~10 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Gaziantep Usulü Etli Nohutlu Kabak', null, '**Hazırlık / Mise en Place**
1. Kabağı kalın küp doğrayın, domatesin kabuğunu soyup küçük küp doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~15 dk · Toplam ~35 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 25, "aktif_dakika": 10, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 95, "enerji_kaynagi": "dogalgaz", "malzemeler": ["KUZU KIYMA", "KABAK", "DOMATES", "KURU SOĞAN", "TUZ", "KARABİBER"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Şanlıurfa Usulü Zeytinyağlı Mercimekli Bulgur', null, '**Hazırlık / Mise en Place**
1. Bulguru ve kırmızı mercimeği yıkayıp süzün, kuru soğanı küçük küp doğrayın.

**Isıl İşlem**
1. Pişirme (~100°C, tencerede, 22 dk): Zeytinyağında soğanı 3-4 dk kavurun. Bulgur ve mercimeği, 200 ml (200 g) sıcak su ve tuzu ekleyin; kaynayınca ateşi kısıp kapağı kapalı olarak bulgur ve mercimek suyunu çekip yumuşayana kadar pişirin.

**PARALEL YAPILABİLİRLİK:** Su ısıtılırken bulgur ve mercimek hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 100, "enerji_kaynagi": "dogalgaz", "malzemeler": ["BULGUR", "KIRMIZI MERCİMEK", "KURU SOĞAN", "ZEYTİNYAĞI", "TUZ", "SU"], "yeni_su_gram": 200}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Diyarbakır Usulü Etli Kavurma', null, '**Hazırlık / Mise en Place**
1. Kuzu etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Mardin Usulü Zeytinyağlı Biberli Patlıcan', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Siirt Usulü Fıstıklı Pilav', null, '**Hazırlık / Mise en Place**
1. Pirinci yıkayıp süzün, Antep fıstığını kabaca kırın.
...
2. Son işlemler: Ocaktan alıp üzerine kırılmış Antep fıstığını serperek servis edin.

**PARALEL YAPILABİLİRLİK:** Tavuk suyu ısıtılırken fıstık kırılabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~13 dk · Pasif bekleme ~12 dk · Toplam ~25 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 5, "aktif_dakika": 5, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 20, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 100, "enerji_kaynagi": "dogalgaz", "malzemeler": ["PİRİNÇ (HAM)", "ANTEP FISTIĞI", "TEREYAĞI", "TAVUK SUYU", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Batman Usulü Etli Nohutlu Bulgur', null, '**Hazırlık / Mise en Place**
1. Bulguru yıkayıp süzün, nohut haşlanmışsa süzün, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Şırnak Usulü Zeytinyağlı Nohutlu Ispanak', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kilis Usulü Etli Kavurma', null, '**Hazırlık / Mise en Place**
1. Kuzu etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
with liste(ad) as (values
    ('İstanbul Usulü Midye Salatası'),
    ('Bursa Usulü Zeytinyağlı Kereviz'),
    ('Kırklareli Usulü Kavurmalı Yumurta'),
    ('Tekirdağ Usulü Fırın Sütlaç'),
    ('Çanakkale Usulü Zeytinyağlı Taze Fasulye'),
    ('Balıkesir Usulü Zeytinyağlı Enginarlı Bezelye'),
    ('Marmara Usulü İncirli Kaşar Tabağı'),
    ('İstanbul Usulü Limonlu Tavuk Sote'),
    ('İzmir Usulü Zeytinyağlı Nohutlu Enginar'),
    ('Muğla Usulü Bal Kaymaklı Kahvaltı Tabağı'),
    ('Datça Usulü Bademli Zeytinyağlı Salata'),
    ('Fethiye Usulü Izgara Karides'),
    ('Salihli Usulü Üzümlü Pilav'),
    ('Nazilli Usulü Etli Nohutlu Bamya'),
    ('Dikili Usulü Zeytinyağlı Semizotu'),
    ('İzmir Usulü Üzümlü Komposto'),
    ('Antalya Usulü Zeytinyağlı Kereviz'),
    ('Mersin Usulü Etli Bamya'),
    ('Adana Usulü Nohutlu Kavurma'),
    ('Hatay Usulü Zeytinyağlı Enginar'),
    ('Silifke Usulü Zeytinyağlı Taze Bakla'),
    ('Antalya Usulü Portakallı Muhallebi'),
    ('Kahramanmaraş Usulü Etli Nohutlu Bulgur'),
    ('Osmaniye Usulü Zeytinyağlı Taze Fasulye'),
    ('Ankara Usulü Etli Nohutlu Bulgur Pilavı'),
    ('Konya Usulü Zeytinyağlı Pırasa'),
    ('Kayseri Usulü Kavurmalı Yumurta'),
    ('Sivas Usulü Zeytinyağlı Nohutlu Kabak'),
    ('Niğde Usulü Elmalı Cevizli Tatlı'),
    ('Aksaray Usulü Etli Kabak Yemeği'),
    ('Kırşehir Usulü Zeytinyağlı Enginar'),
    ('Çorum Usulü Nohutlu Tavuk Sote'),
    ('Trabzon Usulü Zeytinyağlı Kuru Fasulye'),
    ('Rize Usulü Mısır Ekmekli Kaymak Tabağı'),
    ('Samsun Usulü Etli Lahana Yemeği'),
    ('Giresun Usulü Fındıklı Muhallebi'),
    ('Ordu Usulü Zeytinyağlı Taze Fasulye'),
    ('Artvin Usulü Kaşarlı Mısır Ekmeği'),
    ('Bayburt Usulü Etli Kavurma'),
    ('Tokat Usulü Zeytinyağlı Nohutlu Pırasa'),
    ('Erzurum Usulü Etli Nohutlu Kavurma'),
    ('Van Usulü Balı ile Ceviz Tabağı'),
    ('Kars Usulü Etli Kavurma'),
    ('Ağrı Usulü Zeytinyağlı Nohut'),
    ('Muş Usulü Etli Pazı Yemeği'),
    ('Malatya Usulü Kayısılı Komposto'),
    ('Elazığ Usulü Etli Nohutlu Bulgur'),
    ('Bitlis Usulü Zeytinyağlı Semizotu'),
    ('Gaziantep Usulü Etli Nohutlu Kabak'),
    ('Şanlıurfa Usulü Zeytinyağlı Mercimekli Bulgur'),
    ('Diyarbakır Usulü Etli Kavurma'),
    ('Mardin Usulü Zeytinyağlı Biberli Patlıcan'),
    ('Siirt Usulü Fıstıklı Pilav'),
    ('Batman Usulü Etli Nohutlu Bulgur'),
    ('Şırnak Usulü Zeytinyağlı Nohutlu Ispanak'),
    ('Kilis Usulü Etli Kavurma')
)
