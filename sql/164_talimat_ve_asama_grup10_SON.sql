-- 164_talimat_ve_asama_grup10_SON.sql
-- 515 yeni tarifin talimat+asama yazimi -- Grup 10 (SON GRUP):
-- Parti9(tarif-ekleme)'nin 63 tarifi, 7 bolgeye 9'ar esit.
-- Kaynak veri, orijinal 153_yeni_63_tarif_7_bolge_parti9_SON.sql
-- dosyasindan (isim+malzeme+hazirlik_dakika) programatik olarak
-- CIKARILIP DOGRULANDI -- 63/63 isim ve malzeme tam eslesti.
-- Ayni _talimat_ve_asama_ekle_v2 fonksiyonu (155-163 ile ayni).
-- Su eklemeleri capraz kontrol edildi. Hazirlik_dakika duzeltmesi YOK.
-- BU CALISTIKTAN SONRA 515/515 TAMAMLANMIS OLACAK.
...
begin
    perform _talimat_ve_asama_ekle_v2(
        'İstanbul Usulü Zeytinyağlı Nohutlu Kereviz', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Bursa Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Edirne Usulü Kirazlı Komposto', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~14 dk · Pasif bekleme ~11 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kırklareli Usulü Izgara Levrek', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme ~10 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Tekirdağ Usulü Zeytinyağlı Bakla', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.

**Isıl İşlem**
1. Pişirme (~90°C, tencerede, 22 dk): Zeytinyağında soğanı 3-4 dk kavurun, şekeri ekleyip 1 dk çevirin. Baklayı ve tuzu ekleyip kapağı kapalı olarak kısık ateşte bakla yumuşayana kadar pişirin.

**PARALEL YAPILABİLİRLİK:** Pişirme kapaklı ve kısık ateşte ilerlediği için bu sürede başka tarifler hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["BAKLA", "KURU SOĞAN", "ZEYTİNYAĞI", "ŞEKER", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Çanakkale Usulü Kavurmalı Yumurta', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme yok · Toplam ~15 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Balıkesir Usulü Elmalı Ceviz Tatlısı', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~13 dk · Pasif bekleme ~12 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Sakarya Usulü Etli Nohutlu Bulgur', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 25, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 100, "enerji_kaynagi": "dogalgaz", "malzemeler": ["DANA KIYMA", "BULGUR", "NOHUT", "KURU SOĞAN", "TUZ", "KARABİBER"], "yeni_su_gram": 100}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Bilecik Usulü Zeytinyağlı Havuç', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.

**Isıl İşlem**
1. Pişirme (~90°C, tencerede, 22 dk): Zeytinyağında soğanı 3-4 dk kavurun, şekeri ekleyip 1 dk çevirin. Havucu ve tuzu ekleyip kapağı kapalı olarak kısık ateşte havuç yumuşayana kadar pişirin.

**PARALEL YAPILABİLİRLİK:** Pişirme kapaklı ve kısık ateşte ilerlediği için bu sürede başka tarifler hazırlanabilir.

**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 8, "aktif_dakika": 8, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 22, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["HAVUÇ", "KURU SOĞAN", "ZEYTİNYAĞI", "ŞEKER", "TUZ"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'İzmir Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Manisa Usulü Zeytinyağlı Nohutlu Kabak', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Aydın Usulü Etli Bulgur Pilavı', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 25, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 100, "enerji_kaynagi": "dogalgaz", "malzemeler": ["DANA KIYMA", "BULGUR", "KURU SOĞAN", "TUZ", "KARABİBER"], "yeni_su_gram": 150}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Muğla Usulü Zeytinyağlı Nohutlu Havuç', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Bodrum Usulü Izgara Karides (Sarımsaklı)', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kuşadası Usulü Elmalı Komposto', null, '**Hazırlık / Mise en Place**
1. Elmaları soyup dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~14 dk · Pasif bekleme ~11 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Salihli Usulü Kavurmalı Yumurta', null, '**Hazırlık / Mise en Place**
1. Yumurtaları çırpın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme yok · Toplam ~15 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Nazilli Usulü Zeytinyağlı Kereviz', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Antalya Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Mersin Usulü Zeytinyağlı Nohutlu Kereviz', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Adana Usulü Etli Bulgur Pilavı', null, '**Hazırlık / Mise en Place**
1. Bulguru yıkayıp süzün, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Pişirme", "sure_dakika": 25, "aktif_dakika": 8, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 100, "enerji_kaynagi": "dogalgaz", "malzemeler": ["KUZU KIYMA", "BULGUR", "KURU SOĞAN", "TUZ", "KARABİBER"], "yeni_su_gram": 150}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Hatay Usulü Zeytinyağlı Nohutlu Havuç', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Silifke Usulü Izgara Levrek', null, '**Hazırlık / Mise en Place**
1. Levreği temizletip pullarını aldırın, yıkayıp kurulayın.
2. Zeytinyağı, limon suyu ve tuzu karıştırıp balığın üzerine sürün.
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme ~10 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Anamur Usulü Zeytinyağlı Bakla', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kaş Usulü Kavurmalı Yumurta', null, '**Hazırlık / Mise en Place**
1. Yumurtaları çırpın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme yok · Toplam ~15 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Alanya Usulü Elmalı Ceviz Tatlısı', null, '**Hazırlık / Mise en Place**
1. Elmaları soyup dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~13 dk · Pasif bekleme ~12 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kumluca Usulü Zeytinyağlı Kabak', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Ankara Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Konya Usulü Zeytinyağlı Nohutlu Kabak', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kayseri Usulü Etli Nohutlu Patlıcan', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~20 dk · Toplam ~40 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Sivas Usulü Zeytinyağlı Nohutlu Kereviz', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Eskişehir Usulü Izgara Tavuk Kanat', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~25 dk · Pasif bekleme ~10 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Çorum Usulü Kavurmalı Yumurta', null, '**Hazırlık / Mise en Place**
1. Yumurtaları çırpın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme yok · Toplam ~15 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kırşehir Usulü Elmalı Ceviz Tatlısı', null, '**Hazırlık / Mise en Place**
1. Elmaları soyup dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~13 dk · Pasif bekleme ~12 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Nevşehir Usulü Zeytinyağlı Bakla', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Çankırı Usulü Etli Bulgur Pilavı', null, '**Hazırlık / Mise en Place**
1. Bulguru yıkayıp süzün, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Trabzon Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Rize Usulü Zeytinyağlı Nohutlu Kabak', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Samsun Usulü Zeytinyağlı Bakla', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Ordu Usulü Etli Nohutlu Patlıcan', null, '**Hazırlık / Mise en Place**
1. Patlıcanı kalın küp doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~20 dk · Toplam ~40 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Giresun Usulü Kavurmalı Yumurta', null, '**Hazırlık / Mise en Place**
1. Yumurtaları çırpın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme yok · Toplam ~15 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Zonguldak Usulü Elmalı Ceviz Tatlısı', null, '**Hazırlık / Mise en Place**
1. Elmaları soyup dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~13 dk · Pasif bekleme ~12 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kastamonu Usulü Etli Kavurma', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Bartın Usulü Zeytinyağlı Nohutlu Havuç', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Karabük Usulü Etli Bulgur Pilavı', null, '**Hazırlık / Mise en Place**
1. Bulguru yıkayıp süzün, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Erzurum Usulü Etli Nohutlu Patlıcan', null, '**Hazırlık / Mise en Place**
1. Patlıcanı kalın küp doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~20 dk · Toplam ~40 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Erzincan Usulü Zeytinyağlı Nohutlu Kabak', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Van Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
        '[{"sira": 1, "ad": "Hazırlık", "sure_dakika": 10, "aktif_dakika": 10, "isil_islem_mi": false, "baslangic_sicaklik": null, "hedef_sicaklik": null, "enerji_kaynagi": null, "malzemeler": [], "yeni_su_gram": null}, {"sira": 2, "ad": "Kavurma", "sure_dakika": 20, "aktif_dakika": 20, "isil_islem_mi": true, "baslangic_sicaklik": 20, "hedef_sicaklik": 90, "enerji_kaynagi": "dogalgaz", "malzemeler": ["KOYUN ETİ (KOL)", "KİMYON", "KURU SOĞAN", "TUZ", "KARABİBER"], "yeni_su_gram": null}]'::jsonb
    );
    perform _talimat_ve_asama_ekle_v2(
        'Kars Usulü Zeytinyağlı Bakla', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Ağrı Usulü Peynirli Yumurta', null, '**Hazırlık / Mise en Place**
...
**SÜRE ÖZETİ:** Aktif işçilik ~15 dk · Pasif bekleme yok · Toplam ~15 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Muş Usulü Elmalı Ceviz Tatlısı', null, '**Hazırlık / Mise en Place**
1. Elmaları soyup dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~13 dk · Pasif bekleme ~12 dk · Toplam ~25 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Malatya Usulü Zeytinyağlı Nohutlu Kabak', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Elazığ Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Bingöl Usulü Zeytinyağlı Nohutlu Kereviz', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Gaziantep Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Şanlıurfa Usulü Zeytinyağlı Nohutlu Kabak', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Diyarbakır Usulü Etli Bulgur Pilavı', null, '**Hazırlık / Mise en Place**
1. Bulguru yıkayıp süzün, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~18 dk · Pasif bekleme ~17 dk · Toplam ~35 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Mardin Usulü Zeytinyağlı Nohutlu Havuç', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Siirt Usulü Etli Nohutlu Patlıcan', null, '**Hazırlık / Mise en Place**
1. Patlıcanı kalın küp doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~20 dk · Pasif bekleme ~20 dk · Toplam ~40 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Batman Usulü Zeytinyağlı Bakla', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Şırnak Usulü Etli Kavurma (Kimyonlu)', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
**SÜRE ÖZETİ:** Aktif işçilik ~30 dk · Pasif bekleme yok · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Kilis Usulü Zeytinyağlı Nohutlu Pırasa', null, '**Hazırlık / Mise en Place**
1. Sebzeleri hazırlayın (soyma/doğrama), kuru soğanı ince yarım ay dilimleyin.
...
**SÜRE ÖZETİ:** Aktif işçilik ~16 dk · Pasif bekleme ~14 dk · Toplam ~30 dk',
    ...
    perform _talimat_ve_asama_ekle_v2(
        'Adıyaman Usulü Etli Kavurma', null, '**Hazırlık / Mise en Place**
1. Kuzu Etini 2 cm kuşbaşı doğrayın, kuru soğanı küçük küp doğrayın.
...
-- Dogrulama 1: hazirlik_dakika = asama_toplami olmali VE her ISIL
-- asamada en az 1 baglı malzeme olmali. 0 satir donmesi beklenir.
with liste(ad) as (values
    ('İstanbul Usulü Zeytinyağlı Nohutlu Kereviz'),
    ('Bursa Usulü Etli Kavurma (Kimyonlu)'),
    ('Edirne Usulü Kirazlı Komposto'),
    ('Kırklareli Usulü Izgara Levrek'),
    ('Tekirdağ Usulü Zeytinyağlı Bakla'),
    ('Çanakkale Usulü Kavurmalı Yumurta'),
    ('Balıkesir Usulü Elmalı Ceviz Tatlısı'),
    ('Sakarya Usulü Etli Nohutlu Bulgur'),
    ('Bilecik Usulü Zeytinyağlı Havuç'),
    ('İzmir Usulü Etli Kavurma (Kimyonlu)'),
    ('Manisa Usulü Zeytinyağlı Nohutlu Kabak'),
    ('Aydın Usulü Etli Bulgur Pilavı'),
    ('Muğla Usulü Zeytinyağlı Nohutlu Havuç'),
    ('Bodrum Usulü Izgara Karides (Sarımsaklı)'),
    ('Fethiye Usulü Zeytinyağlı Bakla'),
    ('Kuşadası Usulü Elmalı Komposto'),
    ('Salihli Usulü Kavurmalı Yumurta'),
    ('Nazilli Usulü Zeytinyağlı Kereviz'),
    ('Antalya Usulü Etli Kavurma (Kimyonlu)'),
    ('Mersin Usulü Zeytinyağlı Nohutlu Kereviz'),
    ('Adana Usulü Etli Bulgur Pilavı'),
    ('Hatay Usulü Zeytinyağlı Nohutlu Havuç'),
    ('Silifke Usulü Izgara Levrek'),
    ('Anamur Usulü Zeytinyağlı Bakla'),
    ('Kaş Usulü Kavurmalı Yumurta'),
    ('Alanya Usulü Elmalı Ceviz Tatlısı'),
    ('Kumluca Usulü Zeytinyağlı Kabak'),
    ('Ankara Usulü Etli Kavurma (Kimyonlu)'),
    ('Konya Usulü Zeytinyağlı Nohutlu Kabak'),
    ('Kayseri Usulü Etli Nohutlu Patlıcan'),
    ('Sivas Usulü Zeytinyağlı Nohutlu Kereviz'),
    ('Eskişehir Usulü Izgara Tavuk Kanat'),
    ('Çorum Usulü Kavurmalı Yumurta'),
    ('Kırşehir Usulü Elmalı Ceviz Tatlısı'),
    ('Nevşehir Usulü Zeytinyağlı Bakla'),
    ('Çankırı Usulü Etli Bulgur Pilavı'),
    ('Trabzon Usulü Etli Kavurma (Kimyonlu)'),
    ('Rize Usulü Zeytinyağlı Nohutlu Kabak'),
    ('Samsun Usulü Zeytinyağlı Bakla'),
    ('Ordu Usulü Etli Nohutlu Patlıcan'),
    ('Giresun Usulü Kavurmalı Yumurta'),
    ('Zonguldak Usulü Elmalı Ceviz Tatlısı'),
    ('Kastamonu Usulü Etli Kavurma'),
    ('Bartın Usulü Zeytinyağlı Nohutlu Havuç'),
    ('Karabük Usulü Etli Bulgur Pilavı'),
    ('Erzurum Usulü Etli Nohutlu Patlıcan'),
    ('Erzincan Usulü Zeytinyağlı Nohutlu Kabak'),
    ('Van Usulü Etli Kavurma (Kimyonlu)'),
    ('Kars Usulü Zeytinyağlı Bakla'),
    ('Ağrı Usulü Peynirli Yumurta'),
    ('Muş Usulü Elmalı Ceviz Tatlısı'),
    ('Malatya Usulü Zeytinyağlı Nohutlu Kabak'),
    ('Elazığ Usulü Etli Kavurma (Kimyonlu)'),
    ('Bingöl Usulü Zeytinyağlı Nohutlu Kereviz'),
    ('Gaziantep Usulü Etli Kavurma (Kimyonlu)'),
    ('Şanlıurfa Usulü Zeytinyağlı Nohutlu Kabak'),
    ('Diyarbakır Usulü Etli Bulgur Pilavı'),
    ('Mardin Usulü Zeytinyağlı Nohutlu Havuç'),
    ('Siirt Usulü Etli Nohutlu Patlıcan'),
    ('Batman Usulü Zeytinyağlı Bakla'),
    ('Şırnak Usulü Etli Kavurma (Kimyonlu)'),
    ('Kilis Usulü Zeytinyağlı Nohutlu Pırasa'),
    ('Adıyaman Usulü Etli Kavurma')
)
...
-- Dogrulama 2 (SADECE bu son grup basarili olduktan sonra anlamli):
-- artik BUTUN kutuphanede (isletme_id is null) hazirlik_talimati
-- bos olan tek bir tarif kalmamis olmali. 0 satir donmesi beklenir.
select count(*) as talimati_eksik_tarif_sayisi
from receteler
where isletme_id is null and (hazirlik_talimati is null or hazirlik_talimati = '');
